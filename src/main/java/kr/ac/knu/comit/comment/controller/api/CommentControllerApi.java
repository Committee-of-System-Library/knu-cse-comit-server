...
public interface CommentControllerApi {
    ...
    @ApiDoc(
            ...
            descriptions = {
                    ...
                    @FieldDesc(name = "comments", value = "최상위 댓글 목록입니다. 각 항목은 댓글 ID, 본문, 작성자 닉네임, 작성자 프로필 이미지 URL, 좋아요 수, 내 반응 여부, 내 작성 여부, 생성/수정 시각과 대댓글 목록을 포함합니다."),
                    @FieldDesc(name = "id", value = "댓글 ID입니다."),
                    @FieldDesc(name = "content", value = "댓글 본문입니다."),
                    @FieldDesc(name = "authorNickname", value = "댓글 작성자의 닉네임입니다."),
                    @FieldDesc(name = "authorProfileImageUrl", value = "댓글 작성자의 프로필 이미지 URL입니다. 프로필 이미지가 없거나 탈퇴한 사용자면 null입니다."),
                                ...
                                "comments": [
                                  {
                                    ...
                                    "authorProfileImageUrl": "https://cdn.example.com/profiles/orm-master.png",
                                    "likeCount": 4,
                                    "likedByMe": true,
                                    "mine": false,
                                    ...
                                    "replies": [
                                      {
                                        ...
                                        "authorProfileImageUrl": "https://cdn.example.com/profiles/backend-dev.png",
                                        "likeCount": 1,
                                        "likedByMe": false,
                                        "mine": true,
