...
public interface PostControllerApi {
    ...
    @ApiDoc(
            ...
            descriptions = {
                    ...
                    @FieldDesc(name = "posts", value = "게시글 요약 목록입니다. 최신 게시글부터 최대 size개를 반환하며 각 항목은 게시글 ID, 제목, 본문 미리보기, 작성자 닉네임, 작성자 프로필 이미지 URL, 좋아요 수, 댓글 수, 태그, 생성 시각을 포함합니다."),
                    ...
                    @FieldDesc(name = "authorProfileImageUrl", value = "게시글 작성자의 프로필 이미지 URL입니다. 프로필 이미지가 없거나 탈퇴한 사용자면 null입니다."),
